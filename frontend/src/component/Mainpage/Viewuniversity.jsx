                ...
                CollegeList !== null ? (
                    ...
                    <div className="container px-10 mb-5">
                        ...
                        <div className='card px-4 border-none col-md-8 shadow'>
                            <p className=' fw-semibold text-blue-900 fs-2 mt-5 mb-1' style={{ fontFamily: "serif" }}>{CollegeList.universityname}</p>
                            <p className='mb-3 fs-5' style={{ fontFamily: "serif" }}>{CollegeList.universityaddress}</p>
                            ...
                            <p className=' fs-5 text-secondary mb-5'>{CollegeList.universitydetail}</p>
