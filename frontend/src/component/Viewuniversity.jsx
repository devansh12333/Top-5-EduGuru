                    ...
                    <div className="container pt-1 px-16 mb-5">
                        <div className="row text-center flex items-center  flex-col me-5">
                            <div className="card col-md-5" style={{border:"none", width:600}}>
                                <img src={'http://localhost:3000/' + UniversityList.image} onClick={window.scrollTo(0, 0)} alt="" className="img-fluid mb-3"style={{height:500, width:1000}} />

                            </div>
                            </div>
                            <div>

                            <h1 className=' fw-semibold text-red-500 fs-2 mt-3 mb-1' style={{ fontFamily: "serif" }}>{UniversityList.universityname}</h1>
